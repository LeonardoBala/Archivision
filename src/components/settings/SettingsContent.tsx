                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <InputGroup 
                                ...
                                // FIX: Change HTMLTextAreaElement to HTMLInputElement AND update firstName
                        ...
                        <div className="p-8 rounded-3xl border border-white/10 bg-zinc-900/30">
                            ...
                            <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                                <div>
                                    ...
                                    <p className="text-zinc-500 text-sm">Standard generation speed</p>
                                </div>
                                <span className="px-3 py-1 bg-green-500/10 text-green-500 text-xs font-bold uppercase tracking-wider rounded-full">Active</span>
                            </div>
                            <div className="mt-6 pt-6 border-t border-white/5">
                                <p className="text-zinc-400 text-sm mb-4">Want to unlock more features?</p>
                                <button className="w-full py-3 rounded-xl border border-white/10 hover:bg-white hover:text-black transition-all font-medium text-sm">
                                    Upgrade to Pro
                                </button>
                            </div>
                        </div>
...
interface InputGroupProps {
  label: string;
  value: string;
  onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Explicit Input Type
  disabled?: boolean;
  prefix?: string;
  helperText?: string;
}
